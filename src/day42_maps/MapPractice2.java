...
public class MapPractice2 {
    public static void main(String[] args) {
        ...
        car2.put("brand", "Lexus");
        car2.put("model", "LX 500");
        car2.put("year", 2024);
        car2.put("color", "Black");
        car2.put("price", 95000);

        Map<String, Object> car3 = new LinkedHashMap<>();
        car3.put("brand", "Toyota");
        car3.put("model", "Camry");
        car3.put("year", 2023);
        car3.put("color", "White");
        car3.put("price", 35000);

        Map<String, Object> car4 = new LinkedHashMap<>();
        car4.put("brand", "Audi");
        car4.put("model", "Q7");
        car4.put("year", 2024);
        car4.put("color", "Silver");
        car4.put("price", 80000);

...
public class ArrayListPractice {
    ...
    public static void main(String[] args) {
        ...
        for (Employee each : employees) {
            System.out.println(each.name + ": " + each.jonTitle);
        }

        System.out.println("---------------------------------------------------");

        for (Employee each : employees) {
            if (each.jonTitle.equals("Java Developer")){ // if job title of the employee is Java Developer
        ...
        for (Employee eachEmployee : employees) {
            if(eachEmployee.gender == 'M'){ // if employees is male

 ...
 */
        ...
        ArrayList<Dog> female = new ArrayList<>(Arrays.asList(dogs));
        female.removeIf(p -> p.gender == 'M');

        ArrayList<Dog> male = new ArrayList<>(Arrays.asList(dogs));
...
1. Give the following array of dogs
        ...
        1.1 Create an arrayList named smallDogs, and add all the dog objects
        with the size of small from the dogs array to smallDogs arrayList

            Note: DO NOT use any loops

	    1.2 Create an arrayList named youngDogs, and add all the dog objects
	    with the age of 4 or less from the dogs array to youngDogs arrayList

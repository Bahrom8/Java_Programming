...
public class AddElements {
    ...
    public static void main(String[] args) {
        ...
        String[] family = {"Bakhrom", "Dilnoza", "Maryam"};

        family = ArraysUtility.addElement(family, "Yasin");

        family = ArraysUtility.addElement(family, "Yahya");

        family = ArraysUtility.addElement(family, "Yusuf");

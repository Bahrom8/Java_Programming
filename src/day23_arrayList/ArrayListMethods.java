...
public class ArrayListMethods {
    ...
    public static void main(String[] args) {
        ...
        groceriesList.set(0,"Organic Egg");
        ...
        System.out.println( names.lastIndexOf("Peter") );

        boolean hasMuhtar = names.contains("Muhtar"); // false
        boolean hasAnton = names.contains("Anton"); // true

        System.out.println("hasMuhtar = " + hasMuhtar);
        System.out.println("hasAnton = " + hasAnton);
